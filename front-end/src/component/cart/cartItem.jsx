...
export const CartItem = ({ product }) => {
  ...
  const { name, option, color, discount, product_image, quantity, price } =
    product;
  return (
      ...
      <div className="item ">
        ...
        >
          ...
          >
            ...
            >
              <strong>{discountPrice(price * quantity, discount)}</strong>
              <strike>
                {discount !== 0 && discountPrice(price * quantity)}
              </strike>
            </p>
          </div>
